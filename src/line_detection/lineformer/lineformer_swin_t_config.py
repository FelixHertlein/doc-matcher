...
data = dict(
    ...
    workers_per_gpu=4,
    train=[
        dict(type="RepeatDataset", times=50, dataset=PMC_train_data),  # 1400
        dict(type="RepeatDataset", times=1, dataset=AdobeSynth_train_data),  # 40000
        dict(type="RepeatDataset", times=1, dataset=LineEX_train_data),
    ],  # 40000
    test=PMC_test_data,
)
