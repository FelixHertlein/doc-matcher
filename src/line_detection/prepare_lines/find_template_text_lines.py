...
def find_template_text_lines(
    template: np.ndarray,
    information_delta: np.ndarray,
    words: Dict,
    height: int,
    width: int,
    verbose: bool = True,
    ...
    def in_template(word: Dict) -> bool:
        cutout = information_delta[
            word["top"] : word["top"] + word["height"],
